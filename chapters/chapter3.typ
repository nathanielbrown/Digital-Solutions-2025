...
Developers use *#idx("Pseudocode")* as a formal, language-independent method to describe and communicate algorithmic steps before writing actual code.

=== Pseudocode Conventions
Effective pseudocode follows a set of strict conventions to ensure clarity:
- *Keywords*: Use capitalised terms for structural constructs (e.g., `DECLARE`, `IF`, `THEN`, `ELSE`, `WHILE`, `ENDWHILE`, `FUNCTION`).
- *Formatting*: Use consistent *indentation* to show the hierarchy and logical grouping of code blocks.
- *Clarity*: Pseudocode should be descriptive enough for a human to understand but structured enough to be translated into any programming language.
...
To generate functional components, students must master five basic programming features: *variables* (local and global), *control structures*, *data structures* (like Arrays), *syntax*, and *libraries/classes*.

=== Data Structures: Arrays
An *Array* is a data structure that can hold a fixed number of values of a single type. Arrays are used to store multiple items under a single variable name, accessible via an index.
